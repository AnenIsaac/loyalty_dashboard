        ...
        <div className="space-y-6">
          ...
          {isSuccess ? (
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <p className="text-lg font-medium">Promotional SMS sent successfully!</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder="Write your promotional message here... (e.g., 'Special offer just for you! Get 20% off your next visit. Valid until this weekend only!')"
                  ...
                  <div className="flex justify-between text-sm text-gray-500">
                    ...
                    <span>Business name will be automatically added</span>
                  </div>
                </div>
                ...
                {message && (
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    ...
                    <div className="bg-white border rounded p-3">
                      ...
                      <p className="text-sm text-gray-500 mt-2 italic">- [Business Name]</p>
                    </div>
                    <p className="text-xs text-gray-500 mt-2">
                      💡 This is a preview. Your business name will be automatically added to each message.
                    </p>
                  </div>
                )}
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        Send Promotional SMS to {qualifiedCustomerCount} customers
                      </>
                    )}
                  </Button>
                </div>
